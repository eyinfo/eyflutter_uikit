...
class YYDialog {
  ...
  Widget _buildDialogContent() {
    return Container(
      padding: EdgeInsets.only(left: margin.left, top: margin.top, right: margin.right),
      child: Column(
        textDirection: TextDirection.ltr,
        mainAxisAlignment: getColumnMainAxisAlignment(gravity),
        crossAxisAlignment: getColumnCrossAxisAlignment(gravity),
        children: _buildDialogWidgets(),
      ),
    );
  }

  List<Widget> _buildDialogWidgets() {
    return <Widget>[
      Material(
